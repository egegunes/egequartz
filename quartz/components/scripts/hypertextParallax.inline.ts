...
const CANON = [
  // databases on kubernetes — the day job
  "kubernetes",
  "operators",
  "percona",
  "mysql",
  ...
  "gremlins in haproxy",
  "isolating a pxc node",
  "requests and limits",
  "unsafe sysctls",
  "overcommit memory",
  // linux, tools, the toolbox
  "linux",
  "kernel module",
  "insmod",
  "socket types",
  ...
  "don't cut corners",
  "watching it shatter",
  "put something fragile on it",
  "watch the software crumble",
  "update my priors",
...
function initScene(container: HTMLElement) {
  ...
  const syncColors = () => {
    bg = cssColor("--light", "#fdf5ea")
    ink = cssColor("--darkgray", "#4a3018")
    linkInk = cssColor("--secondary", "#c9660a")
    hot = cssColor("--tertiary", "#a8480f")
    if (reduce) draw(0)
  }
